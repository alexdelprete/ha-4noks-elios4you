...
```bash
gh run list --repo alexdelprete/ha-4noks-elios4you --limit 5
```

**Get workflow status for a specific run:**

```bash
gh run view <run_id> --repo alexdelprete/ha-4noks-elios4you
```
...
gh run list --repo alexdelprete/ha-4noks-elios4you --limit 5 | grep Tests
...
**Full Changelog**:
[compare/vPREV...vX.Y.Z](https://github.com/alexdelprete/ha-4noks-elios4you/compare/vPREV...vX.Y.Z)
```
