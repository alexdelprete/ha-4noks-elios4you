...
This is the **first stable v1.0.0 release** of the 4-noks Elios4you integration, marking the
culmination of a comprehensive development journey from initial release to production-ready status.

This release represents a mature, battle-tested integration that has undergone extensive development
and testing cycles, achieving **Home Assistant Quality Scale Platinum tier compliance**.
...
- **Platinum Tier** - All tiers complete including strict typing via ty
...
- **Translation Support** - 10 languages (EN, DE, ES, ET, FI, FR, IT, NB, PT, SV)
