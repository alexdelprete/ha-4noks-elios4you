...
This release focuses on improved test infrastructure, stability fixes, and better recovery notification
handling. It includes all changes from the v1.1.2-beta.1 cycle plus additional test infrastructure
improvements.
...
The integration's module name (`4noks_elios4you`) starts with a digit, which is invalid for Python
identifiers. This creates limitations:
...
No special upgrade steps required. Simply update through HACS or manually replace the integration
files.
