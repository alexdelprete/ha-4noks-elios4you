...
[![GitHub Downloads](https://img.shields.io/github/downloads/alexdelprete/ha-4noks-elios4you/v1.1.1/total?style=for-the-badge)](https://github.com/alexdelprete/ha-4noks-elios4you/releases/tag/v1.1.1)
...
Fixed an issue where recovery notifications would appear empty when clicking on them. Added
`ConfirmRepairFlow` handler to properly display the notification content.
